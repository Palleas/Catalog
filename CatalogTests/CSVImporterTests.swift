...
class CSVImporterTests: XCTestCase {
    ...
    func testImporterRetrieveItems() {
        ...
        XCTAssertEqual(importer.titles[0], "Noël", "First item's title should be Noël.")
        XCTAssertEqual(importer.titles[19], "Sur les routes du monde /", "First item's title should be Sur les routes du monde /.")
    }
}
